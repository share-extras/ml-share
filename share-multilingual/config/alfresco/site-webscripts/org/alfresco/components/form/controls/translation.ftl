...
(function()
{
   ...
   <#if field.control.params.rootNode??>
      ...
      itemFamily: "translation",
      displayMode: "${field.control.params.displayMode!"items"}",
      selectedValue: "${field.control.params.selectedValue}"
   });
})();
//]]></script>
   ...
   <#else>
      ...
      <div id="${controlId}" class="object-finder">
         ...
         <#if field.disabled == false>
            ...
            <input type="hidden" id="${controlId}-lang" name="${field.name}_lang" />
