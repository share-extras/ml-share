		    ...
		    for (var item2 in scope.selectedItems)
				...
				selectedLanguage = item.language;
				   ...
				   '<select id="' + scope.id + '|language"' + ' onchange="OnSelectionChange(this);"' + ' name="' + item.nodeRef +'">' +
                                        '<option id="' + scope.id + '|en" ' + scope.fnIsLangSelected('en',selectedLanguage) + ' name="' + item.nodeRef + '">en</option>' +
                                        '<option id="' + scope.id + '|fr" ' + scope.fnIsLangSelected('fr',selectedLanguage) + ' name="' + item.nodeRef + '">fr</option>' +
                                        '<option id="' + scope.id + '|de" ' + scope.fnIsLangSelected('de',selectedLanguage) + ' name="' + item.nodeRef + '">de</option>' +
                                        '<option id="' + scope.id + '|nl" ' + scope.fnIsLangSelected('nl',selectedLanguage) + ' name="' + item.nodeRef + '">nl</option>' +
                                   '</select>';
